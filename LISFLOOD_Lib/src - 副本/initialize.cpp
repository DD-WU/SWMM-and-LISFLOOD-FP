...
extern "C" int init(int argc, const char *argv[]) {
  ...
  *verbose = OFF;
  ...
  Parptr->InfilRate = 0.0000001;//ÏÂÉø²ÎÊý
  ...
  Statesptr->land_infiltration = OFF;
  SGCptr->NSGCprams=0;
  ...
  //if (Statesptr->land_infiltration == ON)LoadLand_infiltration(Fnameptr, Parptr, Arrptr, verbose);
