...
struct Arrays{
  ...
  double *Manningsn, *SGCManningsn,* land_infiltration;
...
//void LoadLand_infiltration(Fnames* Fnameptr, Pars* Parptr, Arrays* Arrptr, int* verbose);
...
void FPLand_Infiltration(Pars* Parptr, Solver* Solverptr, Arrays* Arrptr);
